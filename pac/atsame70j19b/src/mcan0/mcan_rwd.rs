#[doc = "Reader of register MCAN_RWD"]
pub type R = crate::R<u32, super::MCAN_RWD>;
#[doc = "Writer for register MCAN_RWD"]
pub type W = crate::W<u32, super::MCAN_RWD>;
#[doc = "Register MCAN_RWD `reset()`'s with value 0"]
impl crate::ResetValue for super::MCAN_RWD {
    type Type = u32;
    #[inline(always)]
