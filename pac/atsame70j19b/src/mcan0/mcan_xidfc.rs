#[doc = "Reader of register MCAN_XIDFC"]
pub type R = crate::R<u32, super::MCAN_XIDFC>;
#[doc = "Writer for register MCAN_XIDFC"]
pub type W = crate::W<u32, super::MCAN_XIDFC>;
#[doc = "Register MCAN_XIDFC `reset()`'s with value 0"]
impl crate::ResetValue for super::MCAN_XIDFC {
    type Type = u32;
    #[inline(always)]
