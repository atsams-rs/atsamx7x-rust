#[doc = "Writer for register PIO_MDER"]
pub type W = crate::W<u32, super::PIO_MDER>;
#[doc = "Register PIO_MDER `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_MDER {
    type Type = u32;
    #[inline(always)]
