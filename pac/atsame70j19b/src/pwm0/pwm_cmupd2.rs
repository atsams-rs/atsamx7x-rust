#[doc = "Writer for register PWM_CMUPD2"]
pub type W = crate::W<u32, super::PWM_CMUPD2>;
#[doc = "Register PWM_CMUPD2 `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM_CMUPD2 {
    type Type = u32;
    #[inline(always)]
