...
pub struct RegisterBlock {
    ...
    pub fbtp: crate::Reg<fbtp::FBTP_SPEC>,
    ...
    pub btp: crate::Reg<btp::BTP_SPEC>,
...
pub mod cust;
#[doc = "FBTP register accessor: an alias for `Reg<FBTP_SPEC>`"]
...
pub mod cccr;
#[doc = "BTP register accessor: an alias for `Reg<BTP_SPEC>`"]
