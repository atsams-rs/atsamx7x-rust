#[doc = "Writer for register AFEC_CHDR"]
pub type W = crate::W<u32, super::AFEC_CHDR>;
#[doc = "Register AFEC_CHDR `reset()`'s with value 0"]
impl crate::ResetValue for super::AFEC_CHDR {
    type Type = u32;
    #[inline(always)]
