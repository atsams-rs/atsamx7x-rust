...
pub type PBK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HSTPIPCFG_CTRL_BULK_MODE_SPEC, u8, PBK_A, 2, O>;
...
pub type PSIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, HSTPIPCFG_CTRL_BULK_MODE_SPEC, u8, PSIZE_A, 3, O>;
...
pub type PTOKEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HSTPIPCFG_CTRL_BULK_MODE_SPEC, u8, PTOKEN_A, 2, O>;
...
pub type PTYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, HSTPIPCFG_CTRL_BULK_MODE_SPEC, u8, PTYPE_A, 2, O>;
