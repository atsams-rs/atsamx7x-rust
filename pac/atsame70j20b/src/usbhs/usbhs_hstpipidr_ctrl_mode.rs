#[doc = "Writer for register USBHS_HSTPIPIDR_CTRL_MODE[%s]"]
pub type W = crate::W<u32, super::USBHS_HSTPIPIDR_CTRL_MODE>;
#[doc = "Register USBHS_HSTPIPIDR_CTRL_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_HSTPIPIDR_CTRL_MODE {
    type Type = u32;
    #[inline(always)]
