#[doc = "Reader of register GMAC_SVLAN"]
pub type R = crate::R<u32, super::GMAC_SVLAN>;
#[doc = "Writer for register GMAC_SVLAN"]
pub type W = crate::W<u32, super::GMAC_SVLAN>;
#[doc = "Register GMAC_SVLAN `reset()`'s with value 0"]
impl crate::ResetValue for super::GMAC_SVLAN {
    type Type = u32;
    #[inline(always)]
