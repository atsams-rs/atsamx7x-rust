#[doc = "Reader of register MCAN_NBTP"]
pub type R = crate::R<u32, super::MCAN_NBTP>;
#[doc = "Writer for register MCAN_NBTP"]
pub type W = crate::W<u32, super::MCAN_NBTP>;
#[doc = "Register MCAN_NBTP `reset()`'s with value 0"]
impl crate::ResetValue for super::MCAN_NBTP {
    type Type = u32;
    #[inline(always)]
