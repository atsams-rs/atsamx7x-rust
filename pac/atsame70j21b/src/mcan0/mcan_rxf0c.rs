#[doc = "Reader of register MCAN_RXF0C"]
pub type R = crate::R<u32, super::MCAN_RXF0C>;
#[doc = "Writer for register MCAN_RXF0C"]
pub type W = crate::W<u32, super::MCAN_RXF0C>;
#[doc = "Register MCAN_RXF0C `reset()`'s with value 0"]
impl crate::ResetValue for super::MCAN_RXF0C {
    type Type = u32;
    #[inline(always)]
