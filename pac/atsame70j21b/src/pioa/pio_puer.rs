#[doc = "Writer for register PIO_PUER"]
pub type W = crate::W<u32, super::PIO_PUER>;
#[doc = "Register PIO_PUER `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_PUER {
    type Type = u32;
    #[inline(always)]
