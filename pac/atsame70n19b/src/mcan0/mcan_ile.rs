#[doc = "Reader of register MCAN_ILE"]
pub type R = crate::R<u32, super::MCAN_ILE>;
#[doc = "Writer for register MCAN_ILE"]
pub type W = crate::W<u32, super::MCAN_ILE>;
#[doc = "Register MCAN_ILE `reset()`'s with value 0"]
impl crate::ResetValue for super::MCAN_ILE {
    type Type = u32;
    #[inline(always)]
