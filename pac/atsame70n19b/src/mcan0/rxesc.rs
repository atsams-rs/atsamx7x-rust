...
pub type F0DS_R = crate::FieldReader<u8, F0DS_A>;
impl F0DS_R {
...
pub type F0DS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, RXESC_SPEC, u8, F0DS_A, 3, O>;
...
pub type F1DS_R = crate::FieldReader<u8, F1DS_A>;
impl F1DS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type F1DS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, RXESC_SPEC, u8, F1DS_A, 3, O>;
...
pub type RBDS_R = crate::FieldReader<u8, RBDS_A>;
impl RBDS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type RBDS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, RXESC_SPEC, u8, RBDS_A, 3, O>;
