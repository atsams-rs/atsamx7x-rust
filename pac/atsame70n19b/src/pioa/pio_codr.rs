#[doc = "Writer for register PIO_CODR"]
pub type W = crate::W<u32, super::PIO_CODR>;
#[doc = "Register PIO_CODR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_CODR {
    type Type = u32;
    #[inline(always)]
