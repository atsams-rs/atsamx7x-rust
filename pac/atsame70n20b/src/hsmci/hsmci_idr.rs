#[doc = "Writer for register HSMCI_IDR"]
pub type W = crate::W<u32, super::HSMCI_IDR>;
#[doc = "Register HSMCI_IDR `reset()`'s with value 0"]
impl crate::ResetValue for super::HSMCI_IDR {
    type Type = u32;
    #[inline(always)]
