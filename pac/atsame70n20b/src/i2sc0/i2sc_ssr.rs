#[doc = "Writer for register I2SC_SSR"]
pub type W = crate::W<u32, super::I2SC_SSR>;
#[doc = "Register I2SC_SSR `reset()`'s with value 0"]
impl crate::ResetValue for super::I2SC_SSR {
    type Type = u32;
    #[inline(always)]
