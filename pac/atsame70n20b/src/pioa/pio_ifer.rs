#[doc = "Writer for register PIO_IFER"]
pub type W = crate::W<u32, super::PIO_IFER>;
#[doc = "Register PIO_IFER `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_IFER {
    type Type = u32;
    #[inline(always)]
