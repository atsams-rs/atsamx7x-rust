#[doc = "Writer for register PMC_SLPWK_DR0"]
pub type W = crate::W<u32, super::PMC_SLPWK_DR0>;
#[doc = "Register PMC_SLPWK_DR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::PMC_SLPWK_DR0 {
    type Type = u32;
    #[inline(always)]
