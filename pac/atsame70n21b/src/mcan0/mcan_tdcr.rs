#[doc = "Reader of register MCAN_TDCR"]
pub type R = crate::R<u32, super::MCAN_TDCR>;
#[doc = "Writer for register MCAN_TDCR"]
pub type W = crate::W<u32, super::MCAN_TDCR>;
#[doc = "Register MCAN_TDCR `reset()`'s with value 0"]
impl crate::ResetValue for super::MCAN_TDCR {
    type Type = u32;
    #[inline(always)]
