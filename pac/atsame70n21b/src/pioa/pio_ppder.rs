#[doc = "Writer for register PIO_PPDER"]
pub type W = crate::W<u32, super::PIO_PPDER>;
#[doc = "Register PIO_PPDER `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_PPDER {
    type Type = u32;
    #[inline(always)]
