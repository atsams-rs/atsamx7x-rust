#[doc = "HSTDMANXTDSC register accessor: an alias for `Reg<HSTDMANXTDSC_SPEC>`"]
...
#[doc = "HSTDMAADDRESS register accessor: an alias for `Reg<HSTDMAADDRESS_SPEC>`"]
...
#[doc = "HSTDMACONTROL register accessor: an alias for `Reg<HSTDMACONTROL_SPEC>`"]
...
#[doc = "HSTDMASTATUS register accessor: an alias for `Reg<HSTDMASTATUS_SPEC>`"]
