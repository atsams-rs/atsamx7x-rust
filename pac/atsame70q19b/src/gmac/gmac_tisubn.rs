#[doc = "Reader of register GMAC_TISUBN"]
pub type R = crate::R<u32, super::GMAC_TISUBN>;
#[doc = "Writer for register GMAC_TISUBN"]
pub type W = crate::W<u32, super::GMAC_TISUBN>;
#[doc = "Register GMAC_TISUBN `reset()`'s with value 0"]
impl crate::ResetValue for super::GMAC_TISUBN {
    type Type = u32;
    #[inline(always)]
