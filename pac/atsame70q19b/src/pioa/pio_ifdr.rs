#[doc = "Writer for register PIO_IFDR"]
pub type W = crate::W<u32, super::PIO_IFDR>;
#[doc = "Register PIO_IFDR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_IFDR {
    type Type = u32;
    #[inline(always)]
