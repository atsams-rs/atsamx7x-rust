#[doc = "Writer for register PIO_PUDR"]
pub type W = crate::W<u32, super::PIO_PUDR>;
#[doc = "Register PIO_PUDR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_PUDR {
    type Type = u32;
    #[inline(always)]
