#[doc = "Writer for register QSPI_IDR"]
pub type W = crate::W<u32, super::QSPI_IDR>;
#[doc = "Register QSPI_IDR `reset()`'s with value 0"]
impl crate::ResetValue for super::QSPI_IDR {
    type Type = u32;
    #[inline(always)]
