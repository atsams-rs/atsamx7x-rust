#[doc = "Writer for register DACC_IER"]
pub type W = crate::W<u32, super::DACC_IER>;
#[doc = "Register DACC_IER `reset()`'s with value 0"]
impl crate::ResetValue for super::DACC_IER {
    type Type = u32;
    #[inline(always)]
