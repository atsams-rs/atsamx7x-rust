#[doc = "Reader of register GMAC_TPFCP"]
pub type R = crate::R<u32, super::GMAC_TPFCP>;
#[doc = "Writer for register GMAC_TPFCP"]
pub type W = crate::W<u32, super::GMAC_TPFCP>;
#[doc = "Register GMAC_TPFCP `reset()`'s with value 0"]
impl crate::ResetValue for super::GMAC_TPFCP {
    type Type = u32;
    #[inline(always)]
