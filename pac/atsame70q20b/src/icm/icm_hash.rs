#[doc = "Reader of register ICM_HASH"]
pub type R = crate::R<u32, super::ICM_HASH>;
#[doc = "Writer for register ICM_HASH"]
pub type W = crate::W<u32, super::ICM_HASH>;
#[doc = "Register ICM_HASH `reset()`'s with value 0"]
impl crate::ResetValue for super::ICM_HASH {
    type Type = u32;
    #[inline(always)]
