#[doc = "Register `PMC_SLPWK_SR1` reader"]
pub struct R(crate::R<PMC_SLPWK_SR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PMC_SLPWK_SR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PMC_SLPWK_SR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PMC_SLPWK_SR1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "SleepWalking Status Register 1\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pmc_slpwk_sr1](index.html) module"]
pub struct PMC_SLPWK_SR1_SPEC;
impl crate::RegisterSpec for PMC_SLPWK_SR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pmc_slpwk_sr1::R](R) reader structure"]
impl crate::Readable for PMC_SLPWK_SR1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PMC_SLPWK_SR1 to value 0"]
impl crate::Resettable for PMC_SLPWK_SR1_SPEC {
    #[inline(always)]
