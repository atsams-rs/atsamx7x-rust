#[doc = "Register `SMC_WPSR` reader"]
pub struct R(crate::R<SMC_WPSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SMC_WPSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SMC_WPSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SMC_WPSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "SMC Write Protection Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [smc_wpsr](index.html) module"]
pub struct SMC_WPSR_SPEC;
impl crate::RegisterSpec for SMC_WPSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [smc_wpsr::R](R) reader structure"]
impl crate::Readable for SMC_WPSR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets SMC_WPSR to value 0"]
impl crate::Resettable for SMC_WPSR_SPEC {
    #[inline(always)]
