#[doc = "Reader of register USBHS_HSTDMACONTROL"]
pub type R = crate::R<u32, super::USBHS_HSTDMACONTROL>;
#[doc = "Writer for register USBHS_HSTDMACONTROL"]
pub type W = crate::W<u32, super::USBHS_HSTDMACONTROL>;
#[doc = "Register USBHS_HSTDMACONTROL `reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_HSTDMACONTROL {
    type Type = u32;
    #[inline(always)]
