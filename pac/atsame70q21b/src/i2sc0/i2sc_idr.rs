#[doc = "Writer for register I2SC_IDR"]
pub type W = crate::W<u32, super::I2SC_IDR>;
#[doc = "Register I2SC_IDR `reset()`'s with value 0"]
impl crate::ResetValue for super::I2SC_IDR {
    type Type = u32;
    #[inline(always)]
