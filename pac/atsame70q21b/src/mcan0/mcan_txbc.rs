#[doc = "Reader of register MCAN_TXBC"]
pub type R = crate::R<u32, super::MCAN_TXBC>;
#[doc = "Writer for register MCAN_TXBC"]
pub type W = crate::W<u32, super::MCAN_TXBC>;
#[doc = "Register MCAN_TXBC `reset()`'s with value 0"]
impl crate::ResetValue for super::MCAN_TXBC {
    type Type = u32;
    #[inline(always)]
