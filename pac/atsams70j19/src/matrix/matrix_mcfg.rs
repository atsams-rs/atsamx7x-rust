...
impl ULBTR {
    ...
    pub fn _from(value: u8) -> ULBTR {
        match value {
            0 => ULBTR::UNLTD_LENGTH,
            1 => ULBTR::SINGLE_ACCESS,
            2 => ULBTR::_4BEAT_BURST,
            3 => ULBTR::_8BEAT_BURST,
            4 => ULBTR::_16BEAT_BURST,
            5 => ULBTR::_32BEAT_BURST,
            6 => ULBTR::_64BEAT_BURST,
            7 => ULBTR::_128BEAT_BURST,
            _ => unreachable!(),
        }
    }
