#[doc = "Writer for register PIO_SODR"]
pub type W = crate::W<u32, super::PIO_SODR>;
#[doc = "Register PIO_SODR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_SODR {
    type Type = u32;
    #[inline(always)]
