...
pub type TRGMODE_R = crate::FieldReader<u8, TRGMODE_A>;
impl TRGMODE_R {
...
pub type TRGMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, ETRG1_SPEC, u8, TRGMODE_A, 2, O>;
...
pub type TRGEDGE_R = crate::BitReader<TRGEDGE_A>;
impl TRGEDGE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type TRGEDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETRG1_SPEC, TRGEDGE_A, O>;
