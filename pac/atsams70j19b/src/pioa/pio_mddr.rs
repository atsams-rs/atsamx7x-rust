#[doc = "Writer for register PIO_MDDR"]
pub type W = crate::W<u32, super::PIO_MDDR>;
#[doc = "Register PIO_MDDR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_MDDR {
    type Type = u32;
    #[inline(always)]
