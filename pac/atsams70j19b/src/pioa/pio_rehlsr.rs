#[doc = "Writer for register PIO_REHLSR"]
pub type W = crate::W<u32, super::PIO_REHLSR>;
#[doc = "Register PIO_REHLSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_REHLSR {
    type Type = u32;
    #[inline(always)]
