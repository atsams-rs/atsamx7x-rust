#[doc = "Reader of register US_FIDI"]
pub type R = crate::R<u32, super::US_FIDI>;
#[doc = "Writer for register US_FIDI"]
pub type W = crate::W<u32, super::US_FIDI>;
#[doc = "Register US_FIDI `reset()`'s with value 0"]
impl crate::ResetValue for super::US_FIDI {
    type Type = u32;
    #[inline(always)]
