#[doc = "Writer for register USBHS_HSTPIPIFR_INTRPT_MODE[%s]"]
pub type W = crate::W<u32, super::USBHS_HSTPIPIFR_INTRPT_MODE>;
#[doc = "Register USBHS_HSTPIPIFR_INTRPT_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_HSTPIPIFR_INTRPT_MODE {
    type Type = u32;
    #[inline(always)]
