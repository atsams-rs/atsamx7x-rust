...
pub type TX_PP_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, US_MAN_SPEC, u8, TX_PP_A, 2, O>;
...
pub type RX_PP_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, US_MAN_SPEC, u8, RX_PP_A, 2, O>;
