#[doc = "Reader of register USBHS_DEVDMANXTDSC"]
pub type R = crate::R<u32, super::USBHS_DEVDMANXTDSC>;
#[doc = "Writer for register USBHS_DEVDMANXTDSC"]
pub type W = crate::W<u32, super::USBHS_DEVDMANXTDSC>;
#[doc = "Register USBHS_DEVDMANXTDSC `reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_DEVDMANXTDSC {
    type Type = u32;
    #[inline(always)]
