#[doc = "Writer for register UART_IER"]
pub type W = crate::W<u32, super::UART_IER>;
#[doc = "Register UART_IER `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_IER {
    type Type = u32;
    #[inline(always)]
