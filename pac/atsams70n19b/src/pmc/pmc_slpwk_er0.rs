#[doc = "Writer for register PMC_SLPWK_ER0"]
pub type W = crate::W<u32, super::PMC_SLPWK_ER0>;
#[doc = "Register PMC_SLPWK_ER0 `reset()`'s with value 0"]
impl crate::ResetValue for super::PMC_SLPWK_ER0 {
    type Type = u32;
    #[inline(always)]
