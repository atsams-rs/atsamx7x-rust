#[doc = "Writer for register PWM_CMUPD0"]
pub type W = crate::W<u32, super::PWM_CMUPD0>;
#[doc = "Register PWM_CMUPD0 `reset()`'s with value 0"]
impl crate::ResetValue for super::PWM_CMUPD0 {
    type Type = u32;
    #[inline(always)]
