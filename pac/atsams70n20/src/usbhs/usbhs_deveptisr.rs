#[doc = "Register `USBHS_DEVEPTISR[%s]` reader"]
pub struct R(crate::R<USBHS_DEVEPTISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBHS_DEVEPTISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBHS_DEVEPTISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBHS_DEVEPTISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Device Endpoint Status Register (n = 0) 0\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbhs_deveptisr](index.html) module"]
pub struct USBHS_DEVEPTISR_SPEC;
impl crate::RegisterSpec for USBHS_DEVEPTISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbhs_deveptisr::R](R) reader structure"]
impl crate::Readable for USBHS_DEVEPTISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets USBHS_DEVEPTISR[%s]
to value 0"]
impl crate::Resettable for USBHS_DEVEPTISR_SPEC {
    #[inline(always)]
