#[doc = "Register `USBHS_DEVISR` reader"]
pub struct R(crate::R<USBHS_DEVISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBHS_DEVISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBHS_DEVISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBHS_DEVISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Device Global Interrupt Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbhs_devisr](index.html) module"]
pub struct USBHS_DEVISR_SPEC;
impl crate::RegisterSpec for USBHS_DEVISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbhs_devisr::R](R) reader structure"]
impl crate::Readable for USBHS_DEVISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets USBHS_DEVISR to value 0"]
impl crate::Resettable for USBHS_DEVISR_SPEC {
    #[inline(always)]
