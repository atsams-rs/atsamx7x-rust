#[doc = "Writer for register PIO_FELLSR"]
pub type W = crate::W<u32, super::PIO_FELLSR>;
#[doc = "Register PIO_FELLSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_FELLSR {
    type Type = u32;
    #[inline(always)]
