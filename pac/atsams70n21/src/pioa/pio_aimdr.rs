#[doc = "Writer for register PIO_AIMDR"]
pub type W = crate::W<u32, super::PIO_AIMDR>;
#[doc = "Register PIO_AIMDR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_AIMDR {
    type Type = u32;
    #[inline(always)]
