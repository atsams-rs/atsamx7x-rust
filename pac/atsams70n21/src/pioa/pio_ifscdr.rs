#[doc = "Writer for register PIO_IFSCDR"]
pub type W = crate::W<u32, super::PIO_IFSCDR>;
#[doc = "Register PIO_IFSCDR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_IFSCDR {
    type Type = u32;
    #[inline(always)]
