#[doc = "Register `USBHS_HSTPIPIDR[%s]` writer"]
pub struct W(crate::W<USBHS_HSTPIPIDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBHS_HSTPIPIDR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<USBHS_HSTPIPIDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USBHS_HSTPIPIDR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Host Pipe Disable Register (n = 0) 0\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbhs_hstpipidr](index.html) module"]
pub struct USBHS_HSTPIPIDR_SPEC;
impl crate::RegisterSpec for USBHS_HSTPIPIDR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [usbhs_hstpipidr::W](W) writer structure"]
impl crate::Writable for USBHS_HSTPIPIDR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USBHS_HSTPIPIDR[%s]
to value 0"]
impl crate::Resettable for USBHS_HSTPIPIDR_SPEC {
    #[inline(always)]
