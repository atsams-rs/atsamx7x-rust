#[doc = "Reader of register ICM_DSCR"]
pub type R = crate::R<u32, super::ICM_DSCR>;
#[doc = "Writer for register ICM_DSCR"]
pub type W = crate::W<u32, super::ICM_DSCR>;
#[doc = "Register ICM_DSCR `reset()`'s with value 0"]
impl crate::ResetValue for super::ICM_DSCR {
    type Type = u32;
    #[inline(always)]
