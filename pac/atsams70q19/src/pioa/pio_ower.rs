#[doc = "Writer for register PIO_OWER"]
pub type W = crate::W<u32, super::PIO_OWER>;
#[doc = "Register PIO_OWER `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_OWER {
    type Type = u32;
    #[inline(always)]
