...
pub struct RegisterBlock {
    ...
    pub usbhs_deveptisr_ctrl_mode: [USBHS_DEVEPTISR_CTRL_MODE; 10],
    _reserved2: [u8; 8usize],
    #[doc = "0x160 - Device Endpoint Interrupt Clear Register"]
    pub usbhs_devepticr_ctrl_mode: [USBHS_DEVEPTICR_CTRL_MODE; 10],
    _reserved3: [u8; 8usize],
    #[doc = "0x190 - Device Endpoint Interrupt Set Register"]
    pub usbhs_deveptifr_ctrl_mode: [USBHS_DEVEPTIFR_CTRL_MODE; 10],
    _reserved4: [u8; 8usize],
    #[doc = "0x1c0 - Device Endpoint Interrupt Mask Register"]
    pub usbhs_deveptimr_ctrl_mode: [USBHS_DEVEPTIMR_CTRL_MODE; 10],
    _reserved5: [u8; 8usize],
    #[doc = "0x1f0 - Device Endpoint Interrupt Enable Register"]
    pub usbhs_deveptier_ctrl_mode: [USBHS_DEVEPTIER_CTRL_MODE; 10],
    _reserved6: [u8; 8usize],
    #[doc = "0x220 - Device Endpoint Interrupt Disable Register"]
    pub usbhs_deveptidr_ctrl_mode: [USBHS_DEVEPTIDR_CTRL_MODE; 10],
    ...
    pub usbhs_hstpipisr_ctrl_mode: [USBHS_HSTPIPISR_CTRL_MODE; 10],
    _reserved11: [u8; 8usize],
    #[doc = "0x560 - Host Pipe Clear Register"]
    pub usbhs_hstpipicr_ctrl_mode: [USBHS_HSTPIPICR_CTRL_MODE; 10],
    _reserved12: [u8; 8usize],
    #[doc = "0x590 - Host Pipe Set Register"]
    pub usbhs_hstpipifr_ctrl_mode: [USBHS_HSTPIPIFR_CTRL_MODE; 10],
    _reserved13: [u8; 8usize],
    #[doc = "0x5c0 - Host Pipe Mask Register"]
    pub usbhs_hstpipimr_ctrl_mode: [USBHS_HSTPIPIMR_CTRL_MODE; 10],
    _reserved14: [u8; 8usize],
    #[doc = "0x5f0 - Host Pipe Enable Register"]
    pub usbhs_hstpipier_ctrl_mode: [USBHS_HSTPIPIER_CTRL_MODE; 10],
    _reserved15: [u8; 8usize],
    #[doc = "0x620 - Host Pipe Disable Register"]
    pub usbhs_hstpipidr_ctrl_mode: [USBHS_HSTPIPIDR_CTRL_MODE; 10],
