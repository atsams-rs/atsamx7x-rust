...
pub type NDAIF_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
pub struct _NDAIFW<'a> {
    w: &'a mut W,
}
impl<'a> _NDAIFW<'a> {
...
#[doc = r"Reader of the field"]
pub type NDA_R = crate::FR<u32, u32>;
#[doc = r"Proxy"]
pub struct _NDAW<'a> {
    w: &'a mut W,
}
...
impl W {
    ...
    #[doc = "Bit 0 - Channel x Next Descriptor Interface"]
    #[inline(always)]
    pub fn ndaif(&mut self) -> _NDAIFW {
        _NDAIFW { w: self }
    }
    #[doc = "Bits 2:31 - Channel x Next Descriptor Address"]
    #[inline(always)]
    pub fn nda(&mut self) -> _NDAW {
        _NDAW { w: self }
    }
}
