...
pub type EXNW_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MODE_SPEC, u8, EXNW_MODE_A, 2, O>;
...
pub type BAT_R = crate::BitReader<BAT_A>;
impl BAT_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type BAT_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE_SPEC, BAT_A, O>;
...
pub type DBW_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE_SPEC, DBW_A, O>;
...
pub type PS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, MODE_SPEC, u8, PS_A, 2, O>;
