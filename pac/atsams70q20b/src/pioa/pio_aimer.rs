#[doc = "Writer for register PIO_AIMER"]
pub type W = crate::W<u32, super::PIO_AIMER>;
#[doc = "Register PIO_AIMER `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_AIMER {
    type Type = u32;
    #[inline(always)]
