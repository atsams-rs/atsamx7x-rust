#[doc = "Writer for register QSPI_IER"]
pub type W = crate::W<u32, super::QSPI_IER>;
#[doc = "Register QSPI_IER `reset()`'s with value 0"]
impl crate::ResetValue for super::QSPI_IER {
    type Type = u32;
    #[inline(always)]
