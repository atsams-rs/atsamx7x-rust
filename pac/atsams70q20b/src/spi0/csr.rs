...
pub type CPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CSR_SPEC, CPOL_A, O>;
...
pub type NCPHA_R = crate::BitReader<NCPHA_A>;
impl NCPHA_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type NCPHA_W<'a, const O: u8> = crate::BitWriter<'a, u32, CSR_SPEC, NCPHA_A, O>;
