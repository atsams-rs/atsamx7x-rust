#[doc = "Writer for register PIO_OWDR"]
pub type W = crate::W<u32, super::PIO_OWDR>;
#[doc = "Register PIO_OWDR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_OWDR {
    type Type = u32;
    #[inline(always)]
