...
pub type GCLKCSS_R = crate::FieldReader<u8, GCLKCSS_A>;
impl GCLKCSS_R {
...
pub type GCLKCSS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PCR_SPEC, u8, GCLKCSS_A, 3, O>;
