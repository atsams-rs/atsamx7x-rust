#[doc = "Register `USBHS_HSTPIPIER[%s]` writer"]
pub struct W(crate::W<USBHS_HSTPIPIER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBHS_HSTPIPIER_SPEC>;
    #[inline(always)]
...
impl From<crate::W<USBHS_HSTPIPIER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USBHS_HSTPIPIER_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct USBHS_HSTPIPIER_SPEC;
impl crate::RegisterSpec for USBHS_HSTPIPIER_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [usbhs_hstpipier::W](W) writer structure"]
impl crate::Writable for USBHS_HSTPIPIER_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USBHS_HSTPIPIER[%s]
to value 0"]
impl crate::Resettable for USBHS_HSTPIPIER_SPEC {
    #[inline(always)]
