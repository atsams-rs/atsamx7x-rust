...
pub type TRIGSRCA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EMR_SPEC, u8, TRIGSRCA_A, 2, O>;
...
pub type TRIGSRCB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EMR_SPEC, u8, TRIGSRCB_A, 2, O>;
