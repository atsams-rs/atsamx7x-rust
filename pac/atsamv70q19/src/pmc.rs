...
pub struct RegisterBlock {
    ...
    pub apllacr: crate::Reg<apllacr::APLLACR_SPEC>,
    #[doc = "0x15c - Wait Mode Startup Time Register"]
    pub wmst: crate::Reg<wmst::WMST_SPEC>,
}
...
pub mod slpwk_aipr;
#[doc = "APLLACR register accessor: an alias for `Reg<APLLACR_SPEC>`"]
pub type APLLACR = crate::Reg<apllacr::APLLACR_SPEC>;
#[doc = "Audio PLL Analog Configuration Register"]
pub mod apllacr;
#[doc = "WMST register accessor: an alias for `Reg<WMST_SPEC>`"]
pub type WMST = crate::Reg<wmst::WMST_SPEC>;
