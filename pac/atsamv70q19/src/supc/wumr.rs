...
pub enum SMEN_A {
    #[doc = "0: The supply monitor detection has no wakeup effect."]
    NOT_ENABLE = 0,
    #[doc = "1: The supply monitor detection forces the wakeup of the core power supply."]
    ENABLE = 1,
}
...
#[doc = "Field `SMEN` reader - Supply Monitor Wakeup Enable"]
...
#[doc = "Field `SMEN` writer - Supply Monitor Wakeup Enable"]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RTTEN_A {
    #[doc = "0: The RTT alarm signal has no wakeup effect."]
    NOT_ENABLE = 0,
    #[doc = "1: The RTT alarm signal forces the wakeup of the core power supply."]
    ENABLE = 1,
}
...
#[doc = "Field `RTTEN` reader - Real-time Timer Wakeup Enable"]
...
#[doc = "Field `RTTEN` writer - Real-time Timer Wakeup Enable"]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RTCEN_A {
    #[doc = "0: The RTC alarm signal has no wakeup effect."]
    NOT_ENABLE = 0,
    #[doc = "1: The RTC alarm signal forces the wakeup of the core power supply."]
    ENABLE = 1,
}
...
#[doc = "Field `RTCEN` reader - Real-time Clock Wakeup Enable"]
...
#[doc = "Field `RTCEN` writer - Real-time Clock Wakeup Enable"]
...
pub enum LPDBCEN0_A {
    ...
    NOT_ENABLE = 0,
    #[doc = "1: The WKUP0 input pin is connected to the low-power debouncer and forces a system wakeup."]
    ENABLE = 1,
}
...
pub enum LPDBCEN1_A {
    ...
    NOT_ENABLE = 0,
    #[doc = "1: The WKUP1 input pin is connected to the low-power debouncer and forces a system wakeup."]
    ENABLE = 1,
}
...
#[doc = "Field `WKUPDBC` reader - Wakeup Inputs Debouncer Period"]
...
#[doc = "Field `WKUPDBC` writer - Wakeup Inputs Debouncer Period"]
...
#[repr(u8)]
pub enum LPDBC_A {
    #[doc = "0: Disables the low-power debouncers."]
    DISABLE = 0,
...
impl R {
    #[doc = "Bit 1 - Supply Monitor Wakeup Enable"]
    #[inline(always)]
    pub fn smen(&self) -> SMEN_R {
        SMEN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Real-time Timer Wakeup Enable"]
    #[inline(always)]
    pub fn rtten(&self) -> RTTEN_R {
        RTTEN_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Real-time Clock Wakeup Enable"]
    #[inline(always)]
    ...
    #[doc = "Bits 12:14 - Wakeup Inputs Debouncer Period"]
    #[inline(always)]
