#[doc = "Register `TC_VER` reader"]
pub struct R(crate::R<TC_VER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TC_VER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TC_VER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TC_VER_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Version Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tc_ver](index.html) module"]
pub struct TC_VER_SPEC;
impl crate::RegisterSpec for TC_VER_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tc_ver::R](R) reader structure"]
impl crate::Readable for TC_VER_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TC_VER to value 0"]
impl crate::Resettable for TC_VER_SPEC {
    #[inline(always)]
