#[doc = "Register `USBHS_HSTPIPIMR[%s]` reader"]
pub struct R(crate::R<USBHS_HSTPIPIMR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBHS_HSTPIPIMR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USBHS_HSTPIPIMR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USBHS_HSTPIPIMR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Host Pipe Mask Register (n = 0) 0\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usbhs_hstpipimr](index.html) module"]
pub struct USBHS_HSTPIPIMR_SPEC;
impl crate::RegisterSpec for USBHS_HSTPIPIMR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usbhs_hstpipimr::R](R) reader structure"]
impl crate::Readable for USBHS_HSTPIPIMR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets USBHS_HSTPIPIMR[%s]
to value 0"]
impl crate::Resettable for USBHS_HSTPIPIMR_SPEC {
    #[inline(always)]
