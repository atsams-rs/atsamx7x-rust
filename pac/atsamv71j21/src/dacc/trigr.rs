...
pub enum TRGEN0_A {
    #[doc = "0: Trigger mode disabled. DACC is in Free-running mode or Max speed mode."]
    DIS = 0,
    #[doc = "1: Trigger mode enabled."]
    EN = 1,
}
...
pub type TRGEN0_R = crate::BitReader<TRGEN0_A>;
impl TRGEN0_R {
...
pub type TRGEN0_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRIGR_SPEC, TRGEN0_A, O>;
...
pub type TRGEN1_R = crate::BitReader<TRGEN1_A>;
impl TRGEN1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type TRGEN1_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRIGR_SPEC, TRGEN1_A, O>;
...
pub type TRGSEL0_R = crate::FieldReader<u8, TRGSEL0_A>;
impl TRGSEL0_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type TRGSEL0_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, TRIGR_SPEC, u8, TRGSEL0_A, 3, O>;
...
pub type TRGSEL1_R = crate::FieldReader<u8, TRGSEL1_A>;
impl TRGSEL1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type TRGSEL1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, TRIGR_SPEC, u8, TRGSEL1_A, 3, O>;
...
pub type OSR0_R = crate::FieldReader<u8, OSR0_A>;
impl OSR0_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type OSR0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TRIGR_SPEC, u8, OSR0_A, 3, O>;
...
pub type OSR1_R = crate::FieldReader<u8, OSR1_A>;
impl OSR1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type OSR1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TRIGR_SPEC, u8, OSR1_A, 3, O>;
