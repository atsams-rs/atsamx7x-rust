...
pub mod ccr;
#[doc = "CMR_CAPTURE_MODE register accessor: an alias for `Reg<CMR_CAPTURE_MODE_SPEC>`"]
...
#[doc = "CMR_WAVEFORM_MODE register accessor: an alias for `Reg<CMR_WAVEFORM_MODE_SPEC>`"]
