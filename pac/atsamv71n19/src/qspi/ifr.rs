...
pub type WIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IFR_SPEC, u8, WIDTH_A, 3, O>;
...
pub type OPTL_R = crate::FieldReader<u8, OPTL_A>;
impl OPTL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type OPTL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, IFR_SPEC, u8, OPTL_A, 2, O>;
...
pub type ADDRL_R = crate::BitReader<ADDRL_A>;
impl ADDRL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type ADDRL_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFR_SPEC, ADDRL_A, O>;
...
pub type TFRTYP_R = crate::FieldReader<u8, TFRTYP_A>;
impl TFRTYP_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type TFRTYP_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, IFR_SPEC, u8, TFRTYP_A, 2, O>;
...
pub type CRM_W<'a, const O: u8> = crate::BitWriter<'a, u32, IFR_SPEC, CRM_A, O>;
