...
pub type TCCLKS_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, TCCLKS_A, 3, O>;
...
pub type BURST_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, BURST_A, 2, O>;
...
pub type ETRGEDG_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, ETRGEDG_A, 2, O>;
...
pub type LDRA_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, LDRA_A, 2, O>;
...
pub type LDRB_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, LDRB_A, 2, O>;
...
pub type SBSMPLR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, SBSMPLR_A, 3, O>;
