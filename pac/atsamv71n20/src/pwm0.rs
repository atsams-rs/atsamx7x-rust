...
pub struct RegisterBlock {
    ...
    pub pwm_version: crate::Reg<pwm_version::PWM_VERSION_SPEC>,
    _reserved36: [u8; 0x30],
...
pub mod pwm_wpsr;
#[doc = "PWM_VERSION register accessor: an alias for `Reg<PWM_VERSION_SPEC>`"]
pub type PWM_VERSION = crate::Reg<pwm_version::PWM_VERSION_SPEC>;
