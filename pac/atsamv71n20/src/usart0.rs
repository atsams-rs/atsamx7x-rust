...
pub struct RegisterBlock {
    ...
    pub us_version: crate::Reg<us_version::US_VERSION_SPEC>,
}
...
pub mod us_wpsr;
#[doc = "US_VERSION register accessor: an alias for `Reg<US_VERSION_SPEC>`"]
pub type US_VERSION = crate::Reg<us_version::US_VERSION_SPEC>;
