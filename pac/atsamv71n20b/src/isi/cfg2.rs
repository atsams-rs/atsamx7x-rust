...
pub type YCC_SWAP_R = crate::FieldReader<u8, YCC_SWAP_A>;
impl YCC_SWAP_R {
...
pub type YCC_SWAP_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CFG2_SPEC, u8, YCC_SWAP_A, 2, O>;
...
pub type RGB_CFG_R = crate::FieldReader<u8, RGB_CFG_A>;
impl RGB_CFG_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type RGB_CFG_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CFG2_SPEC, u8, RGB_CFG_A, 2, O>;
