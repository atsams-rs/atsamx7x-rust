...
pub struct RegisterBlock {
    ...
    pub gmac_mid: crate::Reg<gmac_mid::GMAC_MID_SPEC>,
...
pub mod gmac_pefrsh;
#[doc = "GMAC_MID register accessor: an alias for `Reg<GMAC_MID_SPEC>`"]
pub type GMAC_MID = crate::Reg<gmac_mid::GMAC_MID_SPEC>;
