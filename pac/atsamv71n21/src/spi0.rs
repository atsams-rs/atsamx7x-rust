...
pub struct RegisterBlock {
    ...
    pub spi_version: crate::Reg<spi_version::SPI_VERSION_SPEC>,
}
...
pub mod spi_wpsr;
#[doc = "SPI_VERSION register accessor: an alias for `Reg<SPI_VERSION_SPEC>`"]
pub type SPI_VERSION = crate::Reg<spi_version::SPI_VERSION_SPEC>;
