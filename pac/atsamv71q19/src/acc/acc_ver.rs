#[doc = "Register `ACC_VER` reader"]
pub struct R(crate::R<ACC_VER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ACC_VER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ACC_VER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ACC_VER_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct ACC_VER_SPEC;
impl crate::RegisterSpec for ACC_VER_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [acc_ver::R](R) reader structure"]
impl crate::Readable for ACC_VER_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ACC_VER to value 0"]
impl crate::Resettable for ACC_VER_SPEC {
    #[inline(always)]
