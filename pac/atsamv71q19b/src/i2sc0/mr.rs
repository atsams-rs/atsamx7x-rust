...
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MR_SPEC, MODE_A, O>;
...
pub type DATALENGTH_R = crate::FieldReader<u8, DATALENGTH_A>;
impl DATALENGTH_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type DATALENGTH_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, MR_SPEC, u8, DATALENGTH_A, 3, O>;
...
pub type IMCKFS_R = crate::FieldReader<u8, IMCKFS_A>;
impl IMCKFS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type IMCKFS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MR_SPEC, u8, IMCKFS_A, 6, O>;
