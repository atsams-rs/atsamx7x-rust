...
pub struct RegisterBlock {
    ...
    _reserved12: [u8; 0x04],
    #[doc = "0x40..0x60 - Programmable Clock Register (chid = 0) 0"]
    ...
    pub pmc_version: crate::Reg<pmc_version::PMC_VERSION_SPEC>,
    ...
    _reserved38: [u8; 0x10],
    #[doc = "0x158 - Audio PLL Analog Configuration Register"]
    pub pmc_apllacr: crate::Reg<pmc_apllacr::PMC_APLLACR_SPEC>,
    #[doc = "0x15c - Wait Mode Startup Time Register"]
    pub pmc_wmst: crate::Reg<pmc_wmst::PMC_WMST_SPEC>,
}
...
pub mod pmc_wpsr;
#[doc = "PMC_VERSION register accessor: an alias for `Reg<PMC_VERSION_SPEC>`"]
pub type PMC_VERSION = crate::Reg<pmc_version::PMC_VERSION_SPEC>;
...
#[doc = "PMC_APLLACR register accessor: an alias for `Reg<PMC_APLLACR_SPEC>`"]
pub type PMC_APLLACR = crate::Reg<pmc_apllacr::PMC_APLLACR_SPEC>;
#[doc = "Audio PLL Analog Configuration Register"]
pub mod pmc_apllacr;
#[doc = "PMC_WMST register accessor: an alias for `Reg<PMC_WMST_SPEC>`"]
pub type PMC_WMST = crate::Reg<pmc_wmst::PMC_WMST_SPEC>;
