...
pub type MLBCLK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MLBC0_SPEC, u8, MLBCLKSELECT_A, 3, O>;
...
pub type FCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MLBC0_SPEC, u8, FCNTSELECT_A, 3, O>;
