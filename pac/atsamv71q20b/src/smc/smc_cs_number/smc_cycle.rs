#[doc = "Register `SMC_CYCLE` reader"]
pub struct R(crate::R<SMC_CYCLE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SMC_CYCLE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SMC_CYCLE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SMC_CYCLE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SMC_CYCLE` writer"]
pub struct W(crate::W<SMC_CYCLE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SMC_CYCLE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SMC_CYCLE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SMC_CYCLE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "SMC Cycle Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [smc_cycle](index.html) module"]
pub struct SMC_CYCLE_SPEC;
impl crate::RegisterSpec for SMC_CYCLE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [smc_cycle::R](R) reader structure"]
impl crate::Readable for SMC_CYCLE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [smc_cycle::W](W) writer structure"]
impl crate::Writable for SMC_CYCLE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SMC_CYCLE to value 0"]
impl crate::Resettable for SMC_CYCLE_SPEC {
    #[inline(always)]
