...
pub type CSS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, MCKR_SPEC, u8, CSS_A, 2, O>;
...
pub type PRES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, MCKR_SPEC, u8, PRES_A, 3, O>;
...
pub enum MDIV_A {
    ...
    PCK_DIV2 = 1,
    #[doc = "2: MCK is FCLK divided by 4."]
    PCK_DIV4 = 2,
    #[doc = "3: MCK is FCLK divided by 3."]
    PCK_DIV3 = 3,
}
...
pub type MDIV_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, MCKR_SPEC, u8, MDIV_A, 2, O>;
