...
pub struct RegisterBlock {
    ...
    _reserved6: [u8; 0x10],
    #[doc = "0xfc - SMC Version Register"]
    pub smc_version: crate::Reg<smc_version::SMC_VERSION_SPEC>,
}
#[doc = r"Register block"]
#[repr(C)]
...
pub mod smc_wpsr;
#[doc = "SMC_VERSION register accessor: an alias for `Reg<SMC_VERSION_SPEC>`"]
pub type SMC_VERSION = crate::Reg<smc_version::SMC_VERSION_SPEC>;
